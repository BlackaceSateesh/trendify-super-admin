...
import UserProfilePic from "../../assests/dashboard/userProfilepic.png";
      ...
      <div className="UserProfile sectionGap">
        ...
        <div className="reviewSection">
            ...
            <div className="reviewCards">
                <UserReviewCard name='Vimal Pandey' reviewTxt='Greate Product' para='There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour' date='3 Days ago' img={UserLogo} />
                <UserReviewCard name='Rajat Pradhan' reviewTxt='Greate Product' para='There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour' date='3 Days ago' img={UserLogo} />
                <UserReviewCard name='Shyam Seeli' reviewTxt='Greate Product' para='There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour' date='3 Days ago' img={UserLogo} />
            </div>
            </div>
            <div className="sectionContainer">
