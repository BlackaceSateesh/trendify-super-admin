        ...
        <div className="sectionContainer profileTopHeader">
          <div className="profileTop">
            <div className="bannerImg">
              <img
                src={require("../../assests/dashboard/sellerBannerImg.png")}
                alt=""
              />
            </div>
            ...
            <div className="sellerDetails">
              <div className="left">
                <div className="logo">
                  <img src={require("../../assests/app/appLogo.png")} alt="" />
                </div>
                <div className="nameBox">
                  <div className="name">
                    ...
                    <div className="verifyIcon">
                      <img
                        src={require("../../assests/dashboard/verifyGreenTick.png")}
                        alt=""
                      />
                    </div>
                  </div>
            ...
            <div className="userCertifications sectionContainer">
              ...
              <div className="inner">
                <div className="certificate_card">
                  <div className="image">
                    <img
                      src={require("../../assests/dashboard/certificateGST.png")}
                      alt=""
                    />
                  </div>
